...
class TicTacToe:
    ...
    def initialaize_variables(self):
    ...
    def check_for_winner(self):
        ...
        for col in range(len(self.board)):
            if self.board[0][col] == self.board[1][col] == self.board[3][col] and self.board[0][col] != 0:
        ...
        def declare_winner(self, winner):
            ...
            answer = messagebox.askyesno(f"Game over", message + 'Do you want to play aagain?')
